...
1.  **Lake Mead water level is the sum of the protection elevation plus each user’s available water.**
    ...
    ![A diagram of water evaporation Description automatically generated](4890d2b6825df736576fb0d97b5371f3.png)

2.  **Each user manages all their available water not just prior conserved water.**

![A white background with black text Description automatically generated](5d5e1f07842cc149e1993f61d5e69a12.png)

3.  **Tribal Nations of the Lower Basin manage their own settled water rights**

![A pie chart with numbers and a number of states AI-generated content may be incorrect.](76d65ebe7158969bcef62dd8bcad94ca.png)
...
![A screenshot of a computer test AI-generated content may be incorrect.](253efb804c604cf684059a4cd18fdacb.png)Follow the setup and play instructions (Box 1). The rest of the document provides guidance on each step.
...
![](d0cf234ab869f6af3f049b1c58fbe2d1.png)
...
![A graph of a line graph Description automatically generated with medium confidence](b8c3487b2edaa090c29e635c0b64b2c1.png)

**Figure 1a. Range of Lake Mead Evaporation vs Active Storage**

### (ii) Start storage

Reservoir start storage is taken from the [data portal](https://www.usbr.gov/lc/region/g4000/hourly/mead-elv.html) (USBR, 2021b). Text in Column D lists the date. Figure 1b shows Lake Mead storage over time (Solid black line).

![A graph of water and water conservation Description automatically generated with medium confidence](6b1c8702d79a4c42d582bec134c4d9c1.png)
...
![A graph of different colored bars Description automatically generated with medium confidence](fb068f98d855c3c2aad9423fce82b26c.png)
...
![A pie chart with numbers and a number of states AI-generated content may be incorrect.](ca9e80fb94d14438d180ce5c55a6236b.png)
...
![A table with numbers and text Description automatically generated](6fe34cf6e5eb2d852d451ba384aeba63.png)

**Table 1e. Location of each Tribal Nation and amount of settled water rights**

![A table with numbers and text Description automatically generated](9861a30a428c92924d0c609a039c53be.png)
...
**![A graph of different colored lines AI-generated content may be incorrect.](fd507a8f9aa639b557948cbf5f4504b2.png)**
...
**Table 2a. Scenarios of Lake Mea**![A white sheet with black text AI-generated content may be incorrect.](e4fc71eb5784605c5cf05b65ac1df925.png)**d Inflow**
...
![A graph showing a line Description automatically generated](8ba39f9c30237f80872d9c7682e6cb3b.png)

**Figure 2b. Lake Mead inflow as measured by nearest USGS gages.**

![A graph of a number of blue bars Description automatically generated with medium confidence](8109c4025d3cee2e29b1a3d04f9e623c.png)

**Figure 2c. Histogram of Lake Mead inflows as measured by the nearest gages.**

![](504930ff99a905946ec9839391007127.png)
...
![](b0f6fb8c83d308f61784c4ce08a64809.png)
...
![](b53c9ee9aeae742eec9132282c8b5bf3.png)
...
7.  **![A pie chart with numbers and a number of states AI-generated content may be incorrect.](d31a9ef1b56395ad7ea6fcf1bc445251.png)**Finally, we calculate each users percentage share of the inflow as their volume (Table 4a, Columns [H] to [L]) by the total available water (Column [B]).
...
![A table with numbers and text AI-generated content may be incorrect.](b3169f8149953fe0f050119c8d83c24c.png)**Table 4b. Prior agreed Lower Basin shortages and shares of shortages (Buschatzke et al., 2024).**
...
1.  Total Lake Mead inflow [B] = 9.0 ─ Total Shortage [A].
    1.  For example, a total shortage of 1.5 maf yields a Lake Mead inflow of 9.0 ─ 1.5 = 7.5 maf per year.
2.  At 9.0 maf of total inflow [Row 1], each user’s share of the reservoir inflow:
    ...
    1.  A user’s Percent of Reservoir Inflow is their share by volume divided by the total volume.
    -   Arizona [H] = [C] / [G]
    -   Nevada [I] = [D] / [G]
    -   And so forth.
...
1.  Mexico is not influenced by the inclusion of the Tribal Nations in the Share of Lake Mead Inflow Allocation. This is because none of the Tribal Nations water is stored in Mexico.
2.  The Tribal Nations have a steady Lake Mead Inflow percentage of 10.6%.
3.  The percentages highlighted in lilac were chosen to calculate the share of Lake Mead allocation for any inflow in the Master Sheet.
-   Inflow to User = percentage of inflow \* allocation of reservoir inflow for remaining users.
1.  For example, at 5.3 reservoir inflow, California’s inflow is 0.496 \* 5.30 = 2.63 maf.
...
**![A table with numbers and a number of text AI-generated content may be incorrect.](116ba55f46390816a36f1a492b850e04.png)**

# Step 5. Participant Dashboards – Conserve, Consume, and Trade

![A screenshot of a spreadsheet AI-generated content may be incorrect.](33630c7e080c0427f5f8d6ffce5dc1ef.png)Each participant has a dashboard where they can trade, conserve, and consume their available water (Figure 5a).
...
**![A table with numbers and a number of items AI-generated content may be incorrect.](adcd5cc5bbcdece7812c013e317f3785.png)**
...
| ![](b067b34f64dc5f62cef840cc605c1345.png) | (Eq. 2) |
|-------------------------------------------|---------|
...
Enter withdraws and consumptive use according to the strategy identified in Step 1 or modify that strategy based on current conditions.
...
![A table with numbers and a number of states Description automatically generated](d3f9132b7170ab4d0c07a9747336b6f6.png)

**Table 5c. Diversion and consumptive use by Tribal Nations of the Lower Basin (acre-feet).**

![A table with numbers and text Description automatically generated](d72f1e9d8c332c564c4f3413ef9519a8.png)

### (vii) End of Year Balance

The account balance at the end of the year after deducting withdraws and consumptive use. End of Year balance = Available Water – Withdraw.
...
The data, code, and directions to generate figures in this post are available on Github.com at <https://github.com/dzeke/ColoradoRiverCollaborate/tree/main/LakeMeadWaterBankDivideInflow>.
